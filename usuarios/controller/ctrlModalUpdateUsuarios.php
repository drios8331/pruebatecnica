...
$contenidoModal .= "      <div class='col-md mb-3'>";
$contenidoModal .= "          <div class='form-floating'>";
$contenidoModal .= "              <input type='text' class='form-control' id='usuario' placeholder='Usuario' value='" . $listarUsuario[0]['usuario'] . "'>";
...
$contenidoModal .= "          <div class='btn btn-primary rounded-top-0' id='insert_usuario'>Insertar Empleado</div>";
$contenidoModal .= "      </div>";
$contenidoModal .= "  </div>";

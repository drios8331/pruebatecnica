...
echo "   <a href='../../ingresos/view/ingresos.php' class='list-group-item list-group-item-action list-group-item-primary $ingresos' aria-current='$stateIngresos'> <i class='bi bi-cash-coin'></i> Ingresos</a>";
echo "   <a href='../../gastos/view/gastos.php' class='list-group-item list-group-item-action list-group-item-primary $gastos' aria-current='$stateGastos'> <i class='bi bi-door-open-fill'></i> Gastos</a>";
echo '  </div>';
